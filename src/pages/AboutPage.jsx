      ...
      <div
        ...
        <div className="hero-content text-center text-neutral-content">
          <div className="max-w-md">
            ...
            <p className="mb-5">
              Menghadirkan produk berkualitas dengan pelayanan terbaik langsung
              untuk Anda.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="card bg-base-100 shadow-lg text-center">
              <div className="card-body items-center">
                ...
                <p>
                  Proses pengemasan dan pengiriman kami optimalkan agar pesanan
                  Anda tiba lebih cepat dari yang diharapkan.
                </p>
              </div>
            </div>

            {/* Kartu 3: Garansi Aman */}
            <div className="card bg-base-100 shadow-lg text-center">
              <div className="card-body items-center">
